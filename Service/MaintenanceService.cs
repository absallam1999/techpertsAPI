    ...
    public class MaintenanceService : IMaintenanceService
    {
        ...
        public async Task<GeneralResponse<MaintenanceDTO>> AddAsync(MaintenanceCreateDTO dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = $"An unexpected error occurred while creating the maintenance: {ex.Message}",
                    Data = null
                };
            }
        }
        ...
        public async Task<GeneralResponse<bool>> UpdateAsync(string id, MaintenanceUpdateDTO dto)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = $"An unexpected error occurred while updating the maintenance: {ex.Message}",
                    Data = false
                };
            }
        }
        ...
        public async Task<GeneralResponse<bool>> DeleteAsync(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = $"An unexpected error occurred while deleting the maintenance: {ex.Message}",
                    Data = false
                };
            }
        }
