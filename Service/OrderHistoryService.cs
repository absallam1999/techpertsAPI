    ...
    public class OrderHistoryService : IOrderHistoryService
    {
        ...
        public async Task<GeneralResponse<OrderHistoryReadDTO>> GetHistoryByIdAsync(string id)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = $"An unexpected error occurred while retrieving the order history: {ex.Message}",
                    Data = null
                };
            }
        }
        ...
        public async Task<GeneralResponse<IEnumerable<OrderHistoryReadDTO>>> GetAllOrderHistoriesAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Success = false,
                    Message = $"An unexpected error occurred while retrieving order histories: {ex.Message}",
                    Data = null
                };
            }
        }
